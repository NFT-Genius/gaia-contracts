...
describe("transactions test", () => {
  ...
  test("struct set data init", async () => {
    ...
    await shallPass(async () => {
      const setArgs = ["Test Set Data Struct", "Set Description", "https://www.ballerz.xyz/", 
      "image uri", serviceAccount, 0.1];
      return await sendTransaction({ name: "struct_set_data", args: setArgs });
    });
